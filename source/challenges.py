...
my_challenges = [{'id': 0, 'title':'Intro', 'text': intro_text,
                 ...
                 {'id': 1, 'title': 'Robot Position', 'text': ch1_text, 'func_name': 'dist', 'tips':
                  ...
                  'allowed_functions': [], 'required_modules': [], 'weight': 0.3},
                  {'id': 2, 'title': 'La La Land..? Py Py Python!', 'text': ch2_text, 'func_name': 'py_py_python', 'tips': [],
                  'allowed_functions': [], 'required_modules': [], 'weight': 0.7},
                 {'id': 3, 'title': 'Rangoli', 'text': ch3_text, 'func_name': 'rangoli', 'tips':
                  ...
                  'allowed_functions': [], 'required_modules': [], 'weight': 0.9342},
                 {'id': 4, 'title': 'Good Good Robot', 'text': ch4_text, 'func_name': 'prizes',
                  ...
                  'allowed_functions': [], 'required_modules': [], 'weight': 10.54356, 'is_simulation': True},
                 {'id': 5, 'title': 'Darts Championship', 'text': ch5_text, 'func_name': 'combinations',
                  ...
                  'allowed_functions': [], 'required_modules': [], 'weight': 15.88, 'is_simulation': True},
