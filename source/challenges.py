...
my_challenges = [{'id': 0, 'title':'Intro', 'text': intro_text,
                 ...
                 {'id': 1, 'title': 'Robot Position', 'text': ch1_text, 'func_name': 'dist', 'tips':
                  ...
                  'allowed_functions': [], 'required_modules': [], 'max_score': 5},
                  {'id': 2, 'title': 'La La Land..? Py Py Python!', 'text': ch2_text, 'func_name': 'py_py_python', 'tips': [],
                  'allowed_functions': [], 'required_modules': [], 'max_score': 12},
                 {'id': 3, 'title': 'Rangoli', 'text': ch3_text, 'func_name': 'rangoli', 'tips':
                  ...
                  'allowed_functions': [], 'required_modules': [], 'max_score': 15},
                 {'id': 4, 'title': 'Good Good Robot', 'text': ch4_text, 'func_name': 'prizes',
                  'tips': ['A brute force approach will take forever to run, you need to exploit recursion',
                           "Notice that you don't have to compute all possible case explicitly, if a very long sequence starts with LL, then you can cut all the possible combinations that would follow (aka pruning the tree)",
                           'Even if you computed the minimum possible of this sequences, that will still not be enough, you need to cache some operations (if you analyze intermediate steps you will recognize that some are just repeated'],
                  'allowed_functions': [], 'required_modules': [], 'max_score': 17, 'is_simulation': True},
                 {'id': 5, 'title': 'Darts Championship', 'text': ch5_text, 'func_name': 'combinations',
                  'tips': ['You may find useful to "write down" all possible dart combination/score...'],
                  'allowed_functions': [], 'required_modules': [], 'max_score': 25, 'is_simulation': True},
                 {'id': 6, 'title': 'Robot Gardener', 'text': ch6_text, 'func_name': 'water_vacation',
				 'tips': 
