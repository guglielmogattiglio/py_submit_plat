...
my_challenges = [{'id': 1, 'title': 'The + Operation', 
                 ...
                 {'id': 2, 'title': 'Reverse Me', 
                  ...
                  'func_name': 'my_sum', 'max_score': 8, 'tips': ['What if the initial string has an uppercase letter?', 'Note that the string itself may include whitespaces, in that case you have to leave them!'],
